...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 transition">
      ...
      {loading ? (
        <p className="text-gray-500 dark:text-gray-400 text-center mt-10">Yuklanmoqda...</p>
      ) : houses.length === 0 ? (
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  ...
                  <span className="font-semibold text-green-700 dark:text-green-400">
                    {h.price.toLocaleString()} {h.currency === "YE" ? "y.e." : "so‘m"}
                  </span>{" "}
                  / {h.payment_period}
                </p>
